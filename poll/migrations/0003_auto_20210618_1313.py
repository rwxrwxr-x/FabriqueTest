...
def apply_migration(apps, schema_editor):
    QuestionTypes = apps.get_model("poll", "QuestionTypes")
    QuestionTypes.objects.bulk_create(
        [
            QuestionTypes(name="Text Answer"),
            QuestionTypes(name="Single Select"),
            QuestionTypes(name="Multiple Select"),
        ]
    )
